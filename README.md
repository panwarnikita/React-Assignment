...
## 🚀 Live Demo
**[Click here to view the Live App](https://react-assignment-sage-omega.vercel.app/)**
...
* **Markdown Rendering:** Lessons aren't just plain text. I added **syntax highlighting** (Dracula theme) so code blocks look professional.
